        ...
        items: [
          {
            ...
            path: PATH_DASHBOARD.general.createContract,
            icon: ICONS.dashboard,
          },
          // {
          //   title: t('All Organizations'),
          //   path: PATH_DASHBOARD.general.organizations,
          //   icon: ICONS.dashboard,
          // },
          // {
          //   title: t('Create Organizations'),
          //   path: PATH_DASHBOARD.general.CreateOrganization,
          //   icon: ICONS.dashboard,
          // },
          // {
          //   title: t('Create Trial Account'),
          //   path: PATH_DASHBOARD.general.trialAccount,
          //   icon: ICONS.dashboard,
          // },
        ],
        // items: [
